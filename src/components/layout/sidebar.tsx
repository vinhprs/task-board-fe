...
const Sidebar = ({ footer }: SidebarProps) => {
  return (
    <aside className="flex w-[260px] shrink-0 flex-col justify-between bg-slate-950 px-8 py-6 text-white">
      <div>
